...
pub use phuquocdog_primitives::{AccountId, Signature};
pub use phuquocdog_primitives::{AccountIndex, Balance, BlockNumber, Hash, Index, Moment};
...
parameter_types! {
    pub const IndexDeposit: Balance = PQD;
}
...
parameter_types! {
	pub const ExistentialDeposit: Balance = PQD;
...
parameter_types! {
	...
	// 40 PQDs fixed deposit..
	pub const SignedDepositBase: Balance = deposit(2, 0);
	// 0.01 PQD per KB of solution data.
...
parameter_types! {
    pub const CandidacyBond: Balance = 100 * PQD;
...
parameter_types! {
    ...
    pub const ProposalBondMinimum: Balance = 100 * PQD;
    pub const SpendPeriod: BlockNumber = 24 * DAYS;
    pub const Burn: Permill = Permill::from_percent(1);
    pub const TipCountdown: BlockNumber = 1 * DAYS;
    pub const TipFindersFee: Percent = Percent::from_percent(20);
    pub const TipReportDepositBase: Balance = 1 * PQD;
    pub const DataDepositPerByte: Balance = 1 * CENTS;
    pub const BountyDepositBase: Balance = 1 * PQD;
    pub const BountyDepositPayoutDelay: BlockNumber = 8 * DAYS;
    pub const TreasuryPalletId: PalletId = PalletId(*b"py/trsry");
    pub const BountyUpdatePeriod: BlockNumber = 90 * DAYS;
    pub const MaximumReasonLength: u32 = 16384;
    pub const BountyCuratorDeposit: Permill = Permill::from_percent(50);
    pub const BountyValueMinimum: Balance = 10 * PQD;
...
parameter_types! {
    pub const ConfigDepositBase: Balance = 5 * PQD;
    pub const FriendDepositFactor: Balance = 50 * CENTS;
    pub const MaxFriends: u16 = 9;
    pub const RecoveryDeposit: Balance = 5 * PQD;
}
...
parameter_types! {
	pub MinVestedTransfer: Balance = PQD;
...
construct_runtime!(
    pub enum Runtime where
        Block = Block,
        NodeBlock = phuquocdog_primitives::Block,
